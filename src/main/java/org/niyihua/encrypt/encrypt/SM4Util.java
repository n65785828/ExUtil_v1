...
public class SM4Util extends GMBaseUtil implements Encrypt{
    ...
    public static String encryptString(String raw, String key) {
        try {
            return DatatypeConverter.printHexBinary(encrypt_Ecb_Padding(DatatypeConverter.parseHexBinary(key),raw.getBytes(StandardCharsets.UTF_8)));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String decryptString(String cipher, String key) {
        try {
            return new String(decrypt_Ecb_Padding(DatatypeConverter.parseHexBinary(key), DatatypeConverter.parseHexBinary(cipher)), StandardCharsets.UTF_8);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String decrypt(String cipher, String key) {
        return decryptString(cipher,key);
    }
}
